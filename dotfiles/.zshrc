# Keep PATH unique so re-sourced *_profile.sh files don't duplicate entries in nested shells.
typeset -U path PATH
...
alias ll="ls -lA"
alias cc="claude"
alias ccf="CLAUDE_CODE_DISABLE_ADVISOR_TOOL=1 claude --model fable --effort max"
...
source /usr/local/hal-9000/playbooks/roles/aws/files/aws_profile.sh
source /usr/local/hal-9000/playbooks/roles/ai/files/ai_profile.sh
