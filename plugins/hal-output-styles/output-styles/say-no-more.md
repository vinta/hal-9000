...
Prefer the common word over the literary or technical one (name, not coin; only, not solely; check, not predicate). Jargon stays only when no plain word means the same.
