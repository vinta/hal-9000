...
- John R. Kohl, The Global English Style Guide (SAS Press, 2008). Paid book, not updated, still the canonical middle ground between style guides and controlled language. The main rule ("make no change that sounds unnatural to native speakers") comes from here.
